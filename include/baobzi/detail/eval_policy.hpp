#ifndef BAOBZI_DETAIL_EVAL_POLICY_HPP
#define BAOBZI_DETAIL_EVAL_POLICY_HPP
...
inline constexpr poly_eval::ScalarKernel scalar_kernel_for_policy_v =
...
using poly_eval_type_for = std::conditional_t<
    poly_eval::detail::hasTupleSize_v<
        std::remove_cvref_t<poly_eval::fitInput_t<Func>>>,
    poly_eval::FuncEvalND<Func, Degree, poly_eval::FusionMode::Never,
                          scalar_kernel_for_policy_v<Policy>,
                          hybrid_k_for_policy_v<Policy, Degree>>,
...
#endif // BAOBZI_DETAIL_EVAL_POLICY_HPP
