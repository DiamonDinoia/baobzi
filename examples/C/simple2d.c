 ...
 * Shows the scalar `baobzi_eval_f64` and the AoS batch `baobzi_eval_multi_f64`
...
int main(void) {
    ...
    baobzi_t fn = baobzi_fit_f64(bump, NULL,
    ...
    printf("input_dim=%d output_dim=%d memory=%zu bytes\n",
           baobzi_input_dim(fn), baobzi_output_dim(fn), baobzi_memory_usage(fn));
    ...
    double ys[3] = {0};
    baobzi_eval_multi_f64(fn, xs, ys, 3);
